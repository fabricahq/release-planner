...
Release Planner makes it easy to publish release notes people actually want to read. Release Planner plus your coding agent do the tedious work of reviewing what changed and drafting the notes. You stay in charge of what ships: nothing is published until you approve it.
...
2. **Your agent drafts it.** Release Planner lists every change since your last release. Your agent reads them, writes the notes, picks the version, and opens a pull request titled something like **Release v1.1.0**.
