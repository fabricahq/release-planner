...
4. **You:** Review the notes and change anything you like. Nothing is published while the pull request is open. Meanwhile, the release workflow checks the release and builds any files it ships, and keeps a release status section at the end of the pull request description up to date.
